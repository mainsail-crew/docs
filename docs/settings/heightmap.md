---
title: Heightmap Settings
description: Configure the Mainsail bed mesh heightmap visualization, including the
  default viewing orientation and color scheme.
social:
...
![Heightmap Settings](../images/settings/heightmap.png)
</figure>
