...
Crowsnest is a webcam daemon for Raspberry Pi OS distributions like MainsailOS. The service got its name from the crow's nest of a sailing ship. Its purpose is to easily keep an eye on the 3D printer from a distance.
