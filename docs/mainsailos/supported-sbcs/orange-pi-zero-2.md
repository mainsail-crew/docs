...
You can use the Orange Pi Zero 2, a compact SBC based on the Allwinner H616 SoC. Your board provides a 26-pin GPIO
...
Where port base values are: PA=0, PB=32, PC=64, PD=96, PE=128, PF=160, PG=192, PH=224, PI=256, PL=0.
