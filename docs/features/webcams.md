...
- **Dashboard**: The webcam panel appears on the dashboard and can be moved, collapsed, or
  hidden. See [Dashboard Organisation](dashboard-organisation.md) for details.
- **Webcam Page**: A dedicated webcam page can be added to the navigation sidebar. Enable
  this in **Interface Settings** > [UI-Settings](../settings/ui-settings.md).
...
[Webcams Settings](../settings/webcams.md) page.
